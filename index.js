    ...
    try {
        ...
        if (i.isChatInputCommand()) {
            ...
            if (i.commandName === 'вызвать') {
                ...
                return i.reply({
                    content: "📢 **ПАНЕЛЬ КОНТРАКТОВ**\n<@&1373750905274630275><@&1373750899649806449><@&1392858292925108254>\n\n Если вы <@&1392858292925108254> и Вас пикнули в контракт вы так же обязаны смотреть канал <#1526654909452390531> и <#1403074323614404738> и проверять есть ли там Ваш никнейм.\nВы пикаете контракты в игре, после этого нажимаете на кнопку ниже, у вас открывается панель в которой вы вписываете данные для контракта который вы пикнули в игре.\nЕсли пикается человек в соло, то проценты 40% для успешного и 50% для не успешного\nЕсли пикаеются двое и более то проценты 20% для успешного и 40% для не успешного\nНа оплату вы присылаете в обязательном порядке скриншот, так же у вас есть 72 часа на оплату, в случае неоплаты за этот срок, у вас добавляется коэффициент к сумме оплаты x1.25 и на оплату уже этой суммы у вас есть 48 чаcов. В случае неоплаты уже за этот срок у вас накладывается мороз сроком 48 часов в срок которого вы обязаны оплатить сумму после коэффициента, если не будет оплачена афк ранг до оплаты.\nТак же добавляется обязательна регистрация контрактов, в случае несоблюдения этого правила и контракт уже завершился, на человека пикнувишего контракт и не отписавшего в этом канале автоматически налагается штраф на сумму в виде 30% от суммы полученной за контракт.\nЗа всеми вопросами обращаться к <@702529657718833162>",
