    ...
    try {
        ...
        if (i.isChatInputCommand()) {
            ...
            if (i.commandName === 'вызвать') {
                ...
                return i.reply({
                    content: "📢 **ПАНЕЛЬ КОНТРАКТОВ**\n\nВы пикаете контракты в игре, после этого нажимаете на кнопку ниже, у вас открывается панель в которой вы вписываете данные для контракта который вы пикнули в игре.\nЕсли пикается человек в соло, то проценты 40% для успешного и 50% для не успешного\nЕсли пикаеются двое и более то проценты 20% для успешного и 40% для не успешного\nНа оплату вы присылаете в обязательном порядке скриншот, так же у вас есть 72 часа на оплату, в случае неоплаты за этот срок...\n...у вас добавляется коэффициент к сумме оплаты x1.25 и на оплату уже этой суммы у вас есть 48 чаcов...\nВ случае неоплаты уже за этот срок у вас накладывается мороз сроком 48 часов в срок которого вы обязаны оплатить сумму после коэффициента...\nЕсли не будет оплачена афк ранг до оплаты.\nЗа всеми вопросами обращаться к <@702529657718833162>",
